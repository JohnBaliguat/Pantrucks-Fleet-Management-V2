        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="visual-dashboard" aria-expanded="false">
                <i class="ti ti-layout-dashboard"></i>
                <span class="hide-menu">Dashboard</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="visual-performance" aria-expanded="false">
                <i class="ti ti-chart-bar"></i>
                <span class="hide-menu">Performance</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="visual-violationReport" aria-expanded="false">
                <i class="ti ti-alert-circle"></i>
                <span class="hide-menu">Violation Report</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="visual-truckReport" aria-expanded="false">
                <i class="ti ti-dashboard"></i>
                <span class="hide-menu">Truck Movement</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="visual-trailerReport" aria-expanded="false">
                <i class="ti ti-dashboard"></i>
