        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center"><div><h4 class="card-title">Generate Report</h4></div></div>
                  <form id="filterForm" class="row g-3 align-items-center mb-3" method="POST" action="php/reports/violation-report.php" target="_blank">
                    <div class="col-auto"><label class="col-form-label">Violation</label></div>
                    <div class="col-auto">
                    ...
                    <div class="col-auto"><input type="date" id="fromDate" class="form-control"></div>
                    <div class="col-auto"><label class="col-form-label">To</label></div>
                    <div class="col-auto"><input type="date" id="toDate" class="form-control"></div>
                    <div class="col-auto"><button type="button" id="submit" class="btn btn-primary">Generate</button></div>
                    <div class="col-auto"><button type="submit" class="btn btn-success">Export</button></div>
                  </form>
                </div>
              </div>
            </div>
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center"><div><h4 class="card-title">Violation Report</h4></div></div>
    ...
    const table = new DataTable('#table-data', {
      ...
      ajax: {
        ...
        data: function(d) {
          ...
          d.routePrefix = 'visual-violationDriver';
        }
      },
      responsive: true
    });
    $('#submit').on('click', function(e) { e.preventDefault(); table.ajax.reload(); });
  </script>
</body>
</html>
<?php
