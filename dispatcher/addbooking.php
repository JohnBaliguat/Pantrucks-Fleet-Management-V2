...
<body>
                 ...
                 <form id="addForm" action="php/crud/add/addbooking.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row port-fields" id="port_fields" style="display:none;">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <select class="form-control" id="costumer" name="costumer" required data-segment-target="customer_segment">
                          <option value="" data-segment="" selected>-- Select Customer --</option>
                                ...
                                <option value="<?php echo htmlspecialchars($row['customer_code']); ?>" data-segment="<?php echo htmlspecialchars($row['customer_segment']); ?>">
                      ...
                      <div class="mb-3">
                        <label for="customer_segment" class="form-label">
                          Customer Segment <span style="color: red;">*</span>
                        </label>
                          ...
                          <div class="col-md-12">
                           <div class="mb-3">
                              ...
                              <select class="form-control" id="costumer1" name="costumer1" required data-segment-target="customer_segment1">
                                ...
                                <option value="<?php echo htmlspecialchars($row1['customer_code']); ?>" data-segment="<?php echo htmlspecialchars($row1['customer_segment']); ?>">
                            ...
                            <div class="mb-3">
                              <label for="customer_segment1" class="form-label">
                                Customer Segment <span style="color: red;">*</span>
                              </label>
  ...
  <script>
    $(document).ready(function() {
      ...
      // Mirror the Customer Segment field's value into its paired Hauling
      // Segment. Editable: only overwrite when empty or still matching a
      // previous auto-fill, preserving a manual override to a different route.
      ...
      // Each <option> on the customer <select> carries its segment in a
      // data-segment attribute; the segment <select> targeted by
      // data-segment-target is updated to match.
      // Use .attr() (always a string) instead of .data() to avoid jQuery's
      // numeric-string auto-coercion feeding a number into $.escapeSelector.
      ...
      // Keep Hauling Segment in sync when Customer Segment is changed directly.
