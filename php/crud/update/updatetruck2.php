...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result) {
        ...
        $insert_sql = "INSERT INTO shop_unit 
                        (s_unit, s_startDateTime, s_status) 
                       VALUES 
        ...
        if ($insert_result) {
            echo "Truck unit updated and Shop unit inserted successfully!";
        } else {
            $error_message = "Error inserting shop unit: " . (($conn->errorInfo()[2]) ?? "");
