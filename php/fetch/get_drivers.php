...
// A driver is selectable for dispatch when:
// - they are present today and still clocked in, and
// - they do not currently own a live dispatch in an in-flight workflow stage.
$sql = "
    SELECT DISTINCT
        d.driver_id,
        d.driver_fname,
...
while ($row = $result->fetch()) {
    ...
    $shiftTruck = trim($row['shift_truck'] ?? '');
