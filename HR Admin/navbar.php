...
if ($row) {
        ...
        $roleLabel = $row['user_type'] ?? 'HR Admin';
    }
}
$roleLabel = $roleLabel ?? 'HR Admin';
    ...
    <div class="admin-navbar-shell w-100">
      <div class="admin-navbar-left">
        ...
        <div class="admin-navbar-titleblock">
          <div class="admin-navbar-kicker">HR Admin</div>
        ...
        <div class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
            <div class="message-body">
              ...
              <a href="hra-profile" class="d-flex align-items-center gap-2 dropdown-item">
