                  ...
                  <div class="card-body">
                    <div class="d-md-flex align-items-center">
                      ...
                      <div class="ms-auto mt-3 mt-md-0">
                        <a class="btn btn-outline-primary btn-sm" href="printDriverRegistration" target="_blank" rel="noopener"><i class="ti ti-printer"></i> Print Registration Form</a>
                              ...
                              <td class="px-0 text-dark fw-medium text-end">
                                <div class="d-grid gap-2 d-md-block">
                                  ...
                                  <?php } else{?>
                                    ...
                                    <?php }?>
                                  <button class="btn btn-primary btn-sm" type="button" onclick="openUpdateDriver(
                                    '<?php echo $row['driver_id']; ?>',
                                    '<?php echo htmlspecialchars($row['driver_idnumber'] ?? '', ENT_QUOTES); ?>',
                                    '<?php echo htmlspecialchars($row['driver_rfid'] ?? '', ENT_QUOTES); ?>',
                                    '<?php echo htmlspecialchars($row['driver_fname'] ?? '', ENT_QUOTES); ?>',
                                    '<?php echo htmlspecialchars($row['driver_mname'] ?? '', ENT_QUOTES); ?>',
                                    '<?php echo htmlspecialchars($row['driver_lname'] ?? '', ENT_QUOTES); ?>',
                                    '<?php echo htmlspecialchars($row['driver_assignunit'] ?? '', ENT_QUOTES); ?>',
                                    '<?php echo htmlspecialchars($row['driver_assignsegment'] ?? '', ENT_QUOTES); ?>',
                                    '<?php echo htmlspecialchars($row['driver_uname'] ?? '', ENT_QUOTES); ?>',
                                    '<?php echo htmlspecialchars($row['driver_email'] ?? '', ENT_QUOTES); ?>',
                                    '<?php echo htmlspecialchars($row['driver_account_status'] ?? '', ENT_QUOTES); ?>',
                                    '<?php echo htmlspecialchars($row['driver_assignbase'] ?? '', ENT_QUOTES); ?>'
                  ...
                  <div class="column">
                    <div class="select-style-1">
                      ...
                      <div class="select-position">
                        <select class="form-select" name="driver_assignBase" id="driver_assignBase">
            ...
            <form id="editForm" action="php/updatedriver.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="input-style-1">
                  ...
                  <div class="column position-relative">
                    <label for="driver_assignUnit1">Assign Unit</label>
                    <input type="text" class="form-control" name="driver_assignUnit1" id="driver_assignUnit1" placeholder="Select Unit (optional)">
                  ...
                  <div class="column">
                    <label for="driver_assignSegment1">Hauling Segment</label>
                    <select class="form-select" name="driver_assignSegment1" id="driver_assignSegment1">
                      <option value="">-- Select Hauling Segment (optional) --</option>
                      <?php while ($row = ($haulingResult)->fetch()) { ?>
                        <option value="<?php echo htmlspecialchars($row['hauling_segment']); ?>">
                          <?php echo htmlspecialchars($row['hauling_segment']); ?>
                        </option>
                  ...
                  <div class="column">
                    <div class="select-style-1">
                      <label for="driver_assignBase1">Select Assign Location</label>
                      <div class="select-position">
                  ...
                  <div class="column">
                    <label for="driver_email1">Email</label>
                    <input type="email" class="form-control" name="driver_email1" id="driver_email1" placeholder="driver@example.com">
                  </div>
                  <div class="column">
                    <label for="driver_username1">Username</label>
                    <input type="text" class="form-control" name="driver_username1" id="driver_username1" placeholder="Enter Driver Username">
                  </div>
                  <div class="column">
                    <label for="driver_pass1">Password</label>
                    <input type="password" class="form-control" name="driver_pass1" id="driver_pass1" placeholder="Leave blank to keep current password" autocomplete="new-password">
