          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"
                    href="geotab-connection">
                    <div class="d-flex align-items-center gap-3">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
                      <span class="hide-menu">Geotab Connection</span>
                    </div>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"
                    ...
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <span class="hide-menu">Geotab Zones</span>
                    </div>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"
                    ...
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <span class="hide-menu">Vehicle Health</span>
                    </div>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"
                    ...
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <span class="hide-menu">Fuel Reconciliation</span>
                    </div>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"
                    ...
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <span class="hide-menu">Location Coordinates</span>
                    </div>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"
                    href="geotab-behavior">
                    <div class="d-flex align-items-center gap-3">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
                      <span class="hide-menu">Driver Behavior</span>
                    </div>
