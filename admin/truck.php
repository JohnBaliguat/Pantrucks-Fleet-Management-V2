                ...
                <div class="card overflow-hidden">
                  <div class="card-body pb-0">
                    ...
                    <div class="py-3 d-flex align-items-center">
                      ...
                      <div class="ms-auto">
                        <span class="badge bg-secondary-subtle text-muted"><?= $counts['in use'] ?></span>
                      </div>
                    </div>
                    <div class="py-3 d-flex align-items-center">
                  ...
                  <div class="card-body">
                    <div class="d-md-flex align-items-center">
                      ...
                      <div class="ms-auto mt-3 mt-md-0">
                        <a href="unitProfile" class="btn btn-primary btn-sm"><i class="ti ti-plus"></i> Add Truck</a>
                      </div>
                    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
              ...
              <div class="row">
                <div class="input-style-1">
                  <div class="column">
                    ...
                    <input type="text" class="form-control" name="unit_name_update" id="unit_name_update" readonly>
                  </div>
                  <div class="column">
                    <label for="unit_plate">Unit Plate Number</label>
                    <input type="text" class="form-control" name="unit_plate_update" id="unit_plate_update" placeholder="Enter Unit Plate Number" readonly>
                  </div>
                  <div class="column">
                    <label for="unit_location">Location</label>
                    <input type="text" class="form-control" name="unit_location_update" id="unit_location_update" placeholder="Enter Location" readonly>
                  </div>
                  <div class="column">
          ...
          <div class="modal-footer">
            <button class="btn btn-success btn-sm" name="submit" id="FixUnit">Fix Unit</button>
