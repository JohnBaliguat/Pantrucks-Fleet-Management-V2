  ...
  <div>
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="<?php echo (isset($clientCustomerCode) && strcasecmp($clientCustomerCode, 'CTH') === 0) ? 'client-book-cth' : 'client-book'; ?>" aria-expanded="false">
            <i class="ti ti-plus"></i>
            <span class="hide-menu"><?php echo (isset($clientCustomerCode) && strcasecmp($clientCustomerCode, 'CTH') === 0) ? 'CTH Booking' : 'Book a Trip'; ?></span>
          </a>
        </li>
        <li class="sidebar-item">
          <a class="sidebar-link" href="client-mybookings" aria-expanded="false">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="client-profile" aria-expanded="false">
