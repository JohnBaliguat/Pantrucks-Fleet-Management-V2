...
if ($row) {
        ...
        $roleLabel = ($row['user_type'] ?? 'Gastender') === 'Gastender' ? 'Gas Tender' : ($row['user_type'] ?? 'Gas Tender');
    }
}
    ...
    <div class="admin-navbar-shell w-100">
      <div class="admin-navbar-left">
        ...
        <div class="admin-navbar-titleblock">
          <div class="admin-navbar-kicker">Fuel Ticketing</div>
        ...
        <div class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
            <div class="message-body">
              ...
              <a href="gas-profile" class="d-flex align-items-center gap-2 dropdown-item">
                <i class="ti ti-user fs-6"></i>
                <p class="mb-0 fs-3">My Profile</p>
              </a>
              <a href="gas-logout" class="btn btn-outline-primary mx-3 mt-2 d-block">Logout</a>
            </div>
          </div>
        </div>
      </div>
